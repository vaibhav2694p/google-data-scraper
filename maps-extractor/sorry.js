/* =====================================================
   ...
   Runs in background service worker ONLY (imported via importScripts).
   Detects Google's /sorry verification pages and handles
   redirect chains automatically via chrome.webRequest.
   ===================================================== */
...
console.log(getTimestamp(), '[SORRY] Module loaded successfully');
